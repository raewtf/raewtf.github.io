...
title: HEXA Manual
layout: manual
redirect_from: /blog/hexa-manual/
---
...
6. To access your newly-created Mission, access Data Disk Mode on your Playdate by following [these steps](https://help.play.date/games/sideloading/#data-disk-mode), and navigate to <span class="code-span">Data/wtf.rae.hexa/missions</span>.
...
This game connects to Playdate or Steam's on-line leaderboard APIs, to enable sending and receiving of high scores among players across the globe. To use on-line functionality in this game, make sure your device has an active Wireless connection.
...
2. Try playing another round — it doesn't need to be *yet another* new high score, but this might kick the platform's caching into high gear.

3. On Playdate, try checking the scoreboards in-game (see below), which will attempt to send a "fake score" and bump the cache.

## Viewing Global Scores

You can view global scores using two primary methods:

1. On Playdate, visit the *HEXA* game page in your Web browser, at [play.date/games/hexa](https://play.date/games/hexa/). From here, you can view all available scores in the Scoreboards section. You can see top 10 scores in every available board.
...
> ⚠️ *On personal computers, only copies of HEXA being played via Steam are eligible for on-line scoreboards. Other copies of the game, such as those obtained from Itch.io, will not have on-line scoreboard functionality.*
...
- Added localized description strings in the game's metadata
...
<br>
<a href="https://play.date/games/hexa" class="button">Buy <i>HEXA</i> in Playdate Catalog</a>
